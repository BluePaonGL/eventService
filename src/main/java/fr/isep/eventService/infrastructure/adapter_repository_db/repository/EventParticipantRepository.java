...
public interface EventParticipantRepository extends JpaRepository<EventParticipantDAO, Long> {
    List<EventParticipantDAO> getEventParticipantDAOSByEvent_EventId(String eventId);

    EventParticipantDAO findByEvent_EventIdAndParticipantId(String eventId, String participantId);
